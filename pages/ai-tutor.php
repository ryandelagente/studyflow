...
if ($link) {
    $sql = "SELECT id, title, created_at FROM ai_chats WHERE user_id = ? AND tenant_id = ? ORDER BY created_at DESC";
...
<!-- STEP 4: Page-specific HTML content. -->
<main class="flex-1 bg-gray-100 flex h-[calc(100vh-64px)]">
    ...
    <div class="w-1/4 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div id="chatHistoryList" class="flex-1 overflow-y-auto max-h-[calc(100vh-200px)]">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function sendMessageToServer(message) {
        ...
        // DEBUGGING: Log the URL to the console to see what is being requested.
