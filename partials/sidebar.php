         ...
         <div class="pt-4">
            ...
            <div>
                ...
                <div id="settingsDropdown" class="hidden mt-2 space-y-2 pl-8">
                    ...
                    <a href="<?php echo BASE_URL; ?>/pages/users.php" class="block px-4 py-2 rounded-lg hover:bg-gray-700 <?php echo ($current_page === 'users.php') ? 'bg-gray-700' : ''; ?>">Users</a>
                    <?php endif; ?>
                    <a href="<?php echo BASE_URL; ?>/pages/api-settings.php" class="block px-4 py-2 rounded-lg hover:bg-gray-700 <?php echo ($current_page === 'api-settings.php') ? 'bg-gray-700' : ''; ?>">API</a>
                    <a href="<?php echo BASE_URL; ?>/pages/billing.php" class="block px-4 py-2 rounded-lg hover:bg-gray-700 <?php echo ($current_page === 'billing.php') ? 'bg-gray-700' : ''; ?>">Billing</a>
                </div>
            </div>
