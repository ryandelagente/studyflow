         ...
         <div class="pt-4">
            ...
            <div>
                ...
                <div id="settingsDropdown" class="hidden mt-2 space-y-2 pl-8">
                    <a href="<?php echo BASE_URL; ?>/pages/users.php" class="block px-4 py-2 rounded-lg hover:bg-gray-700">Users</a>
                    <a href="<?php echo BASE_URL; ?>/pages/api-settings.php" class="block px-4 py-2 rounded-lg hover:bg-gray-700">API</a>
                    <a href="<?php echo BASE_URL; ?>/pages/billing.php" class="block px-4 py-2 rounded-lg hover:bg-gray-700">Billing</a>
                </div>
            </div>
        </div>
    </nav>
