document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- User Sidebar Dropdown Functionality ---
    ...
    // --- Admin Sidebar Dropdown Functionality ---
    const landingPageBtn = document.getElementById('landingPageBtn');
    if (landingPageBtn) {
        landingPageBtn.addEventListener('click', () => toggleDropdown('landingPageDropdown'));
    }

    const adminSettingsBtn = document.getElementById('adminSettingsBtn');
    if (adminSettingsBtn) {
        // Note: The icon ID is the same as the user sidebar, which is fine.
        adminSettingsBtn.addEventListener('click', () => toggleDropdown('settingsDropdown'));
    }
